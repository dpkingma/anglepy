...
# Matrix to image
def mat_to_img(w, dim_input, scale=False, colorImg=False, tile_spacing=(1,1)):
	rowscols = int(w.shape[1]**0.5)
	imgs = tile_raster_images(X=w.T, img_shape=dim_input, tile_shape=(rowscols,rowscols), tile_spacing=tile_spacing, scale=scale, colorImg=colorImg)
